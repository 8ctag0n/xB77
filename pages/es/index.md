...
hero:
  name: "xB77"
  text: "Infraestructura Financiera Autónoma"
  tagline: "El sistema operativo financiero soberano para la economía de las máquinas."
  actions:
    - theme: brand
      text: Explorar Docs
...
<div class="terminal-container" style="margin-top: 4rem; max-width: 900px; margin-left: auto; margin-right: auto;">
  ...
  <div class="terminal-body">
    <div class="terminal-scroll">
      ...
      <div>[PAY] SHIELDING ASSETS VIA LIGHT PROTOCOL...</div>
      ...
      <div>[END] RECEIPT STORED ON-CHAIN (ENCRYPTED)</div>
      <br/>
