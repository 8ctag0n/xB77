...
pub const SovereignPortal = struct {
    ...
    store: *store.Store,
    vaults: *@import("vault.zig").VaultSet,
    mesh: *@import("mesh.zig").MeshManager,
    port: u16,

    pub fn init(allocator: std.mem.Allocator, s: *store.Store, v: *@import("vault.zig").VaultSet, m: *@import("mesh.zig").MeshManager, port: u16) SovereignPortal {
        return .{
            .allocator = allocator,
            .store = s,
            .vaults = v,
