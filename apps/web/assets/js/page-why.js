...
function WhyPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { background: t.bg, minHeight: "100vh", color: t.text } }, /* @__PURE__ */ React.createElement(InnerNav, { active: "Why xB77" }), /* @__PURE__ */ React.createElement("section", { style: {
    ...
    /* @__PURE__ */ React.createElement("td", { style: { padding: "14px 20px", fontFamily: "var(--sans)", fontSize: 13, color: t.text, borderBottom: `1px solid ${t.border}`, background: hoveredRow === ri ? t.accentDim : "var(--accent-faint)", fontWeight: 500 } }, XB77_ROW[row.key]),
