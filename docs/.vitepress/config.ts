...
export default withMermaid({
  ...
  description:
    'Privacy-first capital management for the machine economy. Shielded payments, ZK-compressed receipts, sovereign agents across Solana, Arc & Sui.',
  lang: 'en-US',
  base: '/xB77/',
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Privacy-first capital management for the machine economy. Shielded payments, ZK-compressed receipts, sovereign agents across Solana, Arc & Sui.' }],
    ['meta', { property: 'og:image', content: '/logo-og.png' }],
    ['meta', { property: 'og:image:width', content: '1200' }],
    ['meta', { property: 'og:image:height', content: '630' }],
    ['meta', { property: 'og:image:alt', content: 'xB77 — Autonomous Financial Infrastructure. Shielded payments, ZK-compressed receipts, sovereign agents across Solana, Arc & Sui.' }],
    ...
    ['meta', { name: 'twitter:description', content: 'Shielded payments · ZK-compressed receipts · sovereign agents across Solana, Arc & Sui.' }],
