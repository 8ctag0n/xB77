...
function AppView() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "xb-app-shell", style: { minHeight: "100vh", padding: "80px 24px 48px", background: "var(--bg, #08080a)" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1280, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 32 } }, /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--mono)", fontSize: 11, color: "rgba(245,245,247,0.55)", letterSpacing: "0.1em", marginBottom: 8 } }, "// APP"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--serif)", fontSize: "clamp(2rem,5vw,3.5rem)", margin: 0, color: "#f5f5f7", lineHeight: 1.05, fontStyle: "italic" } }, "Sovereign commerce surface."), /* @__PURE__ */ React.createElement("p", { style: { color: "rgba(245,245,247,0.55)", marginTop: 12, fontFamily: "var(--mono)", fontSize: 12, letterSpacing: "0.04em" } }, "wallet / agents / pipelines / mesh / explorer \u2014 one origin.")), /* @__PURE__ */ React.createElement("div", { role: "tablist", "aria-label": "App sections", style: {
    display: "flex",
    gap: 0,
