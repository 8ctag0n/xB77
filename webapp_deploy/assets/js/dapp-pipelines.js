function PipelinesView() {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flex: 1, minHeight: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 320, borderRight: `1px solid ${D.border}`, display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 20px", borderBottom: `1px solid ${D.border}`, display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement(DS, { size: 20, italic: true }, "Pipelines"), /* @__PURE__ */ React.createElement(DBtn, { small: true, primary: true }, "+ NEW")), /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflowY: "auto" } }, pipelines.map((p) => /* @__PURE__ */ React.createElement("div", { key: p.id, onClick: () => setSelected(p.id), style: {
    padding: "16px 20px",
